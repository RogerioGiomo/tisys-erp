...
public class ParceiroContatoController {
	...
	public  Response getId(@PathParam("id")  Long id) throws NoResultException {
		 ...
		 ParceiroContato resp = ParceiroContato.findById(id);
		if (resp == null) {
	...
	@Transactional 
 	@Retry(maxRetries = 4)
    public @Valid ParceiroContato create(@Valid  ParceiroContato parceiroContato) {
		ParceiroContato.persist(parceiroContato);
