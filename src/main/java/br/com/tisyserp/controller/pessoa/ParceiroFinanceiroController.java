...
public class ParceiroFinanceiroController {
	...
	public Response getId(@PathParam("id")  Long id) throws NoResultException {
		...
		ParceiroFinanceiro resp = ParceiroFinanceiro.findById(id);
		if (resp == null) {
	...
	@Transactional 
 	@Retry(maxRetries = 4)
    public @Valid ParceiroFinanceiro create(@Valid  ParceiroFinanceiro parceiroFinanceiro) {
		ParceiroFinanceiro.persist(parceiroFinanceiro);
