...
public class ProdutoFamiliaController {
	...
	public Response getId(@PathParam("id")  Long id) throws NoResultException {
		...
		ProdutoFamilia resp = ProdutoFamilia.findById(id);
		if (resp == null) {
	...
	@Transactional 
 	@Retry(maxRetries = 4)
    public @Valid ProdutoFamilia create(@Valid  ProdutoFamilia produtoFamilia) {
		ProdutoFamilia.persist(produtoFamilia);
